<?php /* Smarty version 2.6.0, created on 2013-03-05 18:28:45
...
<tr>
<td><input type="text" name="searchstring" size="20" style="color:<?php if ($this->_tpl_vars['searchstring'] != ""): ?>black<?php else: ?>#3E578F<?php endif; ?>;" value="<?php if ($this->_tpl_vars['searchstring'] != ""):  echo ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['searchstring'])) ? $this->_run_mod_handler('replace', true, $_tmp, '"', '&quot;') : smarty_modifier_replace($_tmp, '"', '&quot;')))) ? $this->_run_mod_handler('replace', true, $_tmp, "\'", "'") : smarty_modifier_replace($_tmp, "\'", "'")))) ? $this->_run_mod_handler('default', true, $_tmp, "") : smarty_modifier_default($_tmp, ""));  else:  echo @constant('STRING_SEARCH');  endif; ?>" onclick="<?php if ($this->_tpl_vars['searchstring'] != ""):  else: ?>this.value='';this.style.color='#000000';<?php endif; ?>"></td>
