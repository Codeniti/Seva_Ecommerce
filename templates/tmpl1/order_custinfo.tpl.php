...
<tr><td colspan=2 align=right><font color=red>*</font>Order ID</td><td><input type='text' name='trackorderid' value='{php}echo rand(2112,1200);{/php}' readonly></td></tr>
<tr>
...
<select name="country" width= 20>
	<option value="{$reg_userinfo[3]|replace:'"':'&quot;'}" >- - - Select your country - - -</option>
...
<p>
<input type="submit" value="{$smarty.const.STRING_PLACE_ORDER}" style="font-weight: bold; font-size: 120%;">
